...
public class ListaEncadeadaComComparator<T> {
    ...
    public ListaEncadeadaComComparator(boolean ehOrdenada, Comparator<T> comp) {
    ...
    public T pesquisar(T valor) {
        ...
        if(this.ordenada) {
            while(auxiliar != null && this.comparador.compare(auxiliar.getValor(), valor) < 0) {
                auxiliar = auxiliar.getProximo();
            }
            ...
            if(this.comparador.compare(auxiliar.getValor(), valor) == 0) {
